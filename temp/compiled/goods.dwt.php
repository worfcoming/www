...
<div class="blank5"></div>
     ...
     <div class="clearfix">
      ...
      <a href="<?php echo $this->_var['prev_good']['url']; ?>"><img alt="prev" src="themes/car/images/up.gif" /></a>
      <?php endif; ?>
      <?php if ($this->_var['next_good']): ?>
      <a href="<?php echo $this->_var['next_good']['url']; ?>"><img alt="next" src="themes/car/images/down.gif" /></a>
      <?php endif; ?>
      </p>
      </div>
      <ul>
