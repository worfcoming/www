...
?>
    ...
    <?php $_from = $this->_var['cb']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cb');if (count($_from)):
    foreach ($_from AS $this->_var['cb']):
?>
    <option value="<?php echo $this->_var['cb']['id']; ?>"><?php echo $this->_var['cb']['alpha']; ?>&nbsp;<?php echo $this->_var['cb']['cbrand_name']; ?></option>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </select>
