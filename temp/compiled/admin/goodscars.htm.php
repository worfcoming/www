...
?>
    ...
    <tr>
        ...
        <select onchange="callbrand(this.value)" name="cbrand" id="cb">
            ...
            <?php $_from = $this->_var['cb']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cb_0_52400600_1341906946');if (count($_from)):
    foreach ($_from AS $this->_var['cb_0_52400600_1341906946']):
?>
            <option value="<?php echo $this->_var['cb_0_52400600_1341906946']['id']; ?>"><?php echo $this->_var['cb_0_52400600_1341906946']['cbrand_name']; ?></option>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </select>
        </td>
        <td bgcolor="#ffffff" align="center">
