...
<table width="100%" id="car-table" align="center">
 <tr>
      <th colspan="20" scope="col" id="gname"><?php echo $this->_var['tittle']; ?></th>
    </tr>
            <tr>
        <td bgcolor="#ffffff" align="center">是否通用</td>
        <td bgcolor="#ffffff" align="center"><input type="checkbox" value="<?php echo $this->_var['aid']; ?>" id="is_common" <?php if ($this->_var['is_common'] == 1): ?> checked="checked"<?php endif; ?>>是</td>
		</tr>
      <tr align="center">
       ...
       <?php $_from = $this->_var['acars']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'icar');if (count($_from)):
...
?>
    ...
    <tr>
        ...
        <select onchange="callbrand(this.value)" name="cbrand" id="cb">
            ...
            <?php $_from = $this->_var['cb']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cb_0_77115900_1341914033');if (count($_from)):
    foreach ($_from AS $this->_var['cb_0_77115900_1341914033']):
?>
            <option value="<?php echo $this->_var['cb_0_77115900_1341914033']['id']; ?>"><?php echo $this->_var['cb_0_77115900_1341914033']['cbrand_name']; ?></option>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            </select>
        </td>
        <td bgcolor="#ffffff" align="center">
        ...
        <td bgcolor="#ffffff" align="center">
        <input type="hidden" name="aid" value="<?php echo $this->_var['aid']; ?>" id="aid" />
